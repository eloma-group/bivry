...
export const PAGE_SEO: Record<string, PageSeo> = {
  ...
  '/blog/line-haul-vs-local-freight': {
    title: 'Linehaul vs Local Freight: Which Delivery Option Do You Need? | Bivry',
    h1: 'Linehaul or Local Freight? How to Choose the Right Delivery Option for Your Business',
    description:
      'Linehaul moves bulk freight between hubs; local freight handles final delivery to the customer. Compare distance, purpose and scheduling to choose the right option for your business.',
  },
}
